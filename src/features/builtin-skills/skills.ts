...
const deepTutorSkill: BuiltinSkill = {
  name: "deep-tutor",
  description:
    "Disciplined task execution with structured exploration, cost-aware tool selection, sufficiency validation, and iteration limits. Prevents premature implementation and infinite loops through systematic validation.",
  template: `# Deep Tutor: Disciplined Task Execution
...
export function createBuiltinSkills(): BuiltinSkill[] {
  return [playwrightSkill, frontendUiUxSkill, gitMasterSkill, deepTutorSkill]
}
